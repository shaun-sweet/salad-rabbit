...
export default class BudgetCategory extends Component {
  ...
  render() {
    ...
    const budgeted = this.props.subcategories.reduce((accumulator, element)=> accumulator + parseInt(element.budgeted), 0);
    //total all outflows columns
    const outflows = this.props.subcategories.reduce((accumulator, element)=> accumulator + parseInt(element.outflow), 0);
